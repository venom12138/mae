...
bash base.sh --finetune $prefix/*times=0,bsp=4,warmup_epochs=5,norm_pix_loss=1,phase=pretrain,*/checkpoint.pth

export run_name="norm_pix_loss=1,phase=$phase,blr=$blr,bs=$batch_size"
bash base.sh --finetune $prefix/*times=1,bsp=4,warmup_epochs=5,norm_pix_loss=1,phase=pretrain,*/checkpoint.pth

export run_name="norm_pix_loss=1,phase=$phase,blr=$blr,bs=$batch_size"
bash base.sh --finetune $prefix/*times=2,bsp=4,warmup_epochs=5,norm_pix_loss=1,phase=pretrain,*/checkpoint.pth