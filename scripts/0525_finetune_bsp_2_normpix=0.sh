...
bash base.sh --finetune $prefix/*times=0,bsp=1,warmup_epochs=5,phase=pretrain,*/checkpoint.pth

export run_name="phase=$phase,blr=$blr,bs=$batch_size"
bash base.sh --finetune $prefix/*times=1,bsp=1,warmup_epochs=5,phase=pretrain,*/checkpoint.pth 

export run_name="phase=$phase,blr=$blr,bs=$batch_size"
bash base.sh --finetune $prefix/*times=2,bsp=1,warmup_epochs=5,phase=pretrain,*/checkpoint.pth 